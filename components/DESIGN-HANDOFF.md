...
This archive is the source of truth for turning the design into production code. Start from `sidebar-redesign.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `sidebar-redesign.html`
...
- A single self-contained `sidebar-redesign.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `sidebar-redesign.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `sidebar-redesign-preview.png`

## Coding checklist for AI tools
1. Inspect `sidebar-redesign.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
